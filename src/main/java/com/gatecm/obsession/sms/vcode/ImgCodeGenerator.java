...
public class ImgCodeGenerator {
	 ...
	 *            图片高
	 */
	public ImgCodeGenerator(int width, int height) {
		this.width = width;
		this.height = height;
		this.createCode();
	}
	 ...
	 *            干扰线条数
	 */
	public ImgCodeGenerator(int width, int height, int codeCount, int lineCount) {
		this.width = width;
		this.height = height;
